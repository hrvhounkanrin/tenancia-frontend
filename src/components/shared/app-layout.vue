<template>
    <div v-if="!$route.meta.plainLayout" class="app-wrapper" v-bind:class="{'sidebar-collapsed': sidebarCollapsed, 'sidebar-open-mobile': sidebarCollapsedMobile}">
        <Sidebar/>
...
import Footer from '@/components/shared/ooter'
