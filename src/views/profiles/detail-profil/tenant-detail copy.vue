  ...
  <div>
    <div class="card card-box-alt card-box-hover-rise card-box-hover mb-5">
      ...
      <div class="card-body">
        ...
        >
          <span>{{
            !haveTenantProfile ? "Créer mon profil" : "Modifier mon profil"
          }}</span>
        </a>
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...mapGetters("user", ["haveTenantProfile", "tenantProfile"]),
