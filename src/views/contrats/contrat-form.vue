          ...
          <div class="card-header">
            ...
            <div class="card-header--actions">
              <b-badge pill variant="success"
                >{{ Number(totalBail).toLocaleString("fr-FR") }} F CFA</b-badge
              >
            </div>
          </div>
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <vue-typeahead-bootstrap
                  ...
                  :screen-reader-text-serializer="
                    (item) => `Github user ${item.user.first_name}`
                  "
                    ...
                    <div class="align-box-row">
                      <div class="mr-2">
                        <a
                          ...
                          class="avatar-icon-wrapper avatar-icon-lg m-0"
                          v-b-tooltip
                          title="View details"
                        >
              ...
              <div class="col-md-6">
                ...
                <vue-typeahead-bootstrap
                  ...
                  :screen-reader-text-serializer="
                    (item) => `Github user ${item.intitule}`
                  "
                  highlightClass="special-highlight-class"
                  :minMatchingChars="1"
                    ...
                    <div class="align-box-row">
                      <div class="mr-2">
                        ...
                        >
                          ...
                          <div class="avatar-icon">
                            <img
                              src="@/assets/img/tenancia_logo_resume.png"
                              alt=""
                            />
                          </div>
                        </a>
                      ...
                      <div class="align-box-row align-items-start">
                        <div>
                          <div class="font-weight-bold">
                            <small
                              class="text-black-50 d-block mb-1 text-uppercase"
                              >Locataire</small
                            >
                            <span class="font-size-sm mt-1">{{
                        ...
                        <div
                          class="ml-auto card-hover-indicator align-self-center"
                          @click="removeAppartment"
                        >
                          <font-awesome-icon
                            icon="trash"
                            class="font-size-xl danger"
                            style="color: red"
                          />
                        </div>
                      </div>
                      ...
                      <div class="align-box-row align-items-start">
                        <div>
                          <div class="font-weight-bold">
                            ...
                            >
                            <span class="font-size-sm mt-1"
                              >{{ selectedAppartement.intitule }} (Immeuble:
                              {{ selectedAppartement.immeuble_intitule }})</span
                            >
                          </div>
                          <div class="mt-2">
                            <font-awesome-icon
                            ...
                            />
                            <span class="pr-1">{{
                              selectedAppartement.ville
                            }}</span>
                          </div>
                          <div class="mt-2">
                            <font-awesome-icon icon="user-tag" class="mr-1" />
                            <span class="pr-1">{{
                              selectedAppartement.proprietaire
                            }}</span>
                          </div>
                        </div>
                        <div
            ...
            <div class="form-row">
              <div class="form-group col-md-3">
                ...
                />
                <span
                  v-if="validations.jour_emission"
                  class="invalid-feedback d-block"
                  >Jour d'émission incorrect.</span
                >
              </div>
              <div class="form-group col-md-3">
                ...
                />
                <span
                  v-if="validations.jour_valeur"
                  class="invalid-feedback d-block"
                  >Jour valeur incorrect.</span
                >
              </div>
            ...
            <div class="form-row">
              <div class="form-group col-md-3">
                ...
                <datepicker
                  ...
                  :input-class="{ 'is-invalid': validations.date_effet }"
                  format="yyyy-MM-dd"
                  calendar-class="datepicker datepicker-dropdown dropdown-menu"
                  :bootstrap-styling="true"
                  v-model="contrat.date_effet"
                >
                </datepicker>
                <span
                  v-if="validations.date_effet"
                  class="invalid-feedback d-block"
                  >Date d'effet incorrect.</span
                >
              </div>
              <div class="form-group col-md-3">
                ...
                <span
                  v-if="validations.date_signature"
                  class="invalid-feedback d-block"
                  >Date signature incorrect.</span
                >
              </div>
              <div class="form-group col-md-3">
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input
                  ...
                  v-money="money"
                  v-model="contrat.montant_bail"
                />
                <span
                  v-if="validations.montant_bail"
                  class="invalid-feedback d-block"
                  >Montant bail incorrect.</span
                >
              </div>
              <div class="form-group col-md-3">
                ...
                <input
                  ...
                  @blur="infoAccessoires"
                />
                <span
                  v-if="validations.nb_avance"
                  class="invalid-feedback d-block"
                  >Nbre d'avance incorrect.</span
                >
              </div>
              <div class="form-group col-md-3">
                ...
                <input
                  ...
                  v-model="contrat.nb_prepaye"
                  @blur="infoAccessoires"
                />
                <span
                  v-if="validations.nb_prepaye"
                  class="invalid-feedback d-block"
                  >Nbre de prépayé incorrect.</span
                >
              </div>
            </div>
            ...
            <b-list-group id="contrat-accessoires">
              <b-list-group-item
                class="
                  ...
                  bg-light
                "
                v-for="item in contrat.accessoires"
                :key="item.id"
              >
                <div class="w-100">
                  <div class="d-flex">
                    ...
                    <div class="p-2">
                      {{ item.montant.toLocaleString("fr-FR") }} ({{
                        item.is_peridic ? "PERIODIQUE" : "PONCTUEL"
                      }}
                      )
                    </div>
        ...
        <div class="card card-box mb-5">
          <div class="card-header">
            <div class="card-header--title">
              ...
              <small
                >Choisissez un type de frais accessoire, renseigner le montant
                puis ajouter au contrat, ou créer un nouveau..</small
              >
            </div>
            <div class="card-header--actions">
              {{ filterValue }}
          ...
          <div class="card-body">
            <div class="input-group mb-2">
              <input
                type="search"
                class="form-control"
                placeholder="Filtrer type d'accessoires sur loyer"
                v-model="filterValue"
              />
              ...
              <VuePerfectScrollbar class="scrollbar-container scroll-area-md">
                <b-list-group-item
                  class="
                    ...
                    align-items-center
                  "
                  v-for="item in notSelectedAccessories"
                  :key="item.id"
                  >{{ item.libelle }}
                  <span class="">
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <label class="input-group-text" :for="'chk_' + item.id"
                          >Périodique</label
                        >
                      </div>
                      <div class="input-group-prepend">
                        <div class="input-group-text">
                          <b-form-checkbox
                            size="lg"
                            v-model="item.is_peridic"
                            :id="'chk_' + item.id"
                            >{{
                              item.is_peridic ? "OUI" : "NON"
                            }}</b-form-checkbox
                          >
                        </div>
                      </div>
...
export default {
  ...
  computed: {
    ...
    notSelectedAccessories: function () {
      ...
      let allNotSelected = this.typeAccessoires.filter(
    ...
    totalBail: function () {
      ...
      let montant_bail = isNaN(this.contrat.montant_bail)
        ? utils.currencyToNumber(this.contrat.montant_bail)
        : this.contrat.montant_bail;
      let totalLoyer =
        montant_bail * this.contrat.nb_avance +
        montant_bail * this.contrat.nb_prepaye;
      return (
        totalLoyer +
        this.contrat.accessoires.reduce(
          (accumulateur, item) =>
            accumulateur + utils.currencyToNumber(item.montant),
          0
        )
      );
    },
  ...
  methods: {
    ...
    getAppartments: debounce(function () {
      ...
      let params = {
        query: this.filterAppartmentQuery,
        statut_appartement: "LIBRE",
      };
    ...
    addAccessoires: function (accessoire) {
      if (
        utils.currencyToNumber(accessoire.montant) === 0 ||
        accessoire.montant === null
      ) {
        this.$toast.open({
    ...
    infoAccessoires: function () {
      ...
      this.$toast.open({
        message:
          "Pour une bonne gestion vous devez ajouter les frais accessoires au contrat. Regardez dans le panneau à votre droite pour le faire...",
        type: "info",
        duration: 6000,
        pauseOnHover: true,
      });
    ...
    removeAccessoire: function (accessoire) {
      let index = this.contrat.accessoires.findIndex(
        (item) => item.id === accessoire.id
      );
      this.contrat.accessoires.splice(index, 1);
    },
    validate: function () {
      this.validations.date_effet =
        this.contrat.date_effet !== null ? false : true;
      this.validations.date_signature =
        this.contrat.date_signature !== null ? false : true;
      this.validations.montant_bail =
        utils.currencyToNumber(this.contrat.montant_bail) > 0 ? false : true;
      this.validations.jour_emission =
        this.contrat.jour_emission !== null && this.contrat.jour_emission > 0
          ? false
          : true;
      this.validations.jour_valeur =
        this.contrat.jour_valeur !== null && this.contrat.jour_valeur > 0
          ? false
          : true;
      this.validations.nb_avance =
        this.contrat.nb_avance !== null ? false : true;
      this.validations.nb_prepaye =
        this.contrat.nb_prepaye !== null ? false : true;
      ...
      if (!this.selectedTenant) {
        ...
        this.$toast.open({
          message:
            "Vous devez ajouter un locataire. Recherchez le par son email...",
          type: "error",
          position: "top",
          duration: 6000,
          pauseOnHover: true,
      ...
      if (!this.selectedAppartement) {
        ...
        this.$toast.open({
          message:
            "Vous devez ajouter un appartement. Recherchez le par son nom (ex: 0-A)",
          type: "error",
          position: "top",
          duration: 6000,
          pauseOnHover: true,
    ...
    saveContrat: async function () {
      ...
      contratToSave.montant_bail = utils.currencyToNumber(
        contratToSave.montant_bail
      );
      contratToSave.accessoires.map(
        (item) => (item.montant = utils.currencyToNumber(item.montant))
      );
      contratToSave.date_effet = moment(contratToSave.date_effet)
        .format("YYYY-MM-DD")
        .toString();
      contratToSave.date_signature = moment(contratToSave.date_signature)
        .format("YYYY-MM-DD")
        .toString();
      ...
      let actionToTrigger =
        contratToSave && contratToSave.id > 0
          ? "contrats/updateContrat"
          : "contrats/createContrat";
      this.$store.dispatch(actionToTrigger, contratToSave).then(() => {
        if (
          !this.api_errors.find((e) => e.key === "createContrat") &&
          !this.api_errors.find((e) => e.key === "updateContrat")
        ) {
