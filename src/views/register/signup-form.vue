  ...
  <div>
    <div class="card-header p-3 pt-0 rounded bg-light">
      ...
      <div class="text-center">
        <button class="btn btn-google-plus mr-2" type="button">
          <span class="btn-wrapper--icon">
            <font-awesome-icon :icon="['fab', 'google']" />
          </span>
          <span class="btn-wrapper--label"> Mon compte Google </span>
        </button>
      </div>
    </div>
    <form @submit.prevent="localSignup">
      <div class="px-4 py-2">
        ...
        <div class="custom-control custom-control-alternative custom-checkbox">
          <input class="custom-control-input" id="cgu" type="checkbox" />
